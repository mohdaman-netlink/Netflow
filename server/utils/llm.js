...
// Preserve the historical auto-detection preference and append OpenAI. An
// explicit LLM_PROVIDER is tried first when its key is configured.
const PROVIDER_FALLBACK_ORDER = ['anthropic', 'nvidia', 'groq', 'gemini', 'openai']
