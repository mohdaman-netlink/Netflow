var _a, _b;
import { d as drawRect } from "./chunk-F27PBJKO.BBRLBtat.js";
...
var getDiagramRoot = /* @__PURE__ */ __name((id, securityLevel) => {
  ...
  if (securityLevel === "sandbox") {
    ...
    const doc = (_a2 = sandboxElement.node()) == null ? void 0 : _a2.contentDocument;
    if (!doc) {
...
var stereotypeText = /* @__PURE__ */ __name((shape) => {
  ...
  return ((_a2 = shape.techn) == null ? void 0 : _a2.text) ? `[${stereotype}: ${shape.techn.text}]` : `[${stereotype}]`;
}, "stereotypeText");
...
var buildC4Node = /* @__PURE__ */ __name((shape, config, padding, look, elementWidth) => {
  ...
  return {
    ...
    description: ((_a2 = shape.descr) == null ? void 0 : _a2.text) ? [shape.descr.text] : void 0,
    labelType: "string",
    isGroup: false,
    shape: nodeShape,
